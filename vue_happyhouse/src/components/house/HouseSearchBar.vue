<template>
  <div class="bg-light text-dark">
    ...
    <b-row>
      <b-col>
        <input
          ...
          v-model="apt"
          id="apt"
          @keydown.enter="aptlist" />
        <b-button @click="aptlist" variant="secondary" size="sm">검색</b-button>
      </b-col>
      <b-col>
    ...
    <b-row>
      <b-col id="text-search">
        <p>
          <b-icon icon="house-fill"></b-icon> 일반 병원 이름, 분류명으로 검색
        </p>
      </b-col>
    ...
    <b-row class="" v-if="selected == 'hospitalGeneral'">
      <b-col sm="6">
        <input
          type="text"
          v-model="hospital"
          ...
          style="width: 120px" />
        <b-button @click="searchHospitalByName" variant="secondary" size="sm"
          >검색</b-button
        >
      </b-col>
      <b-col sm="6">
    ...
    <!-- 약국 -->
    <b-row id="text-search" v-if="selected == 'pharmacy'">
    ...
    <!-- 선별진료소 -->
    <b-row id="text-search" v-if="selected == 'hospitalCovid'">
...
import HouseAvgList from "@/components/house/HouseAvgList.vue";
import HouseAvgListSinCity from "@/components/house/HouseAvgListSinCity.vue";
